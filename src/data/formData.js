...
export const JobInputArray = [
	{ name: "title", label: 'Job Title', type: 'text' },
	{ name: "jobCategory", label: 'Job Category', type: 'select', options: jobCategories },
	{ name: "company", label: 'Company', type: 'select', options: currencies },
	{ name: "minSalary", label: 'Min Salary', type: 'number' },
	{ name: "maxSalary", label: 'Max Salary', type: 'number' },
	{ name: "minYears", label: 'Min Years', type: 'number' },
	{ name: "maxYears", label: 'Max Years', type: 'number' },
	{ name: "city", label: 'City', type: 'select' },
	{ name: "state", label: 'State', type: 'select' },
	{ name: "country", label: 'Country', type: 'select' },
	{ name: "jobType", label: 'Job Type', type: 'select', options: jobTypes },
	{ name: "remoteOption", label: 'Remote Option', type: 'select', options: remoteOptions },
	{ name: "applyURL", label: 'Apply URL', type: 'url', },
	{ name: "postingDate", label: 'Posting Date', type: 'date', },
	{ name: "applicationDeadline", label: 'ApplicationDeadline', type: 'date', },
];
